...
public class OnboardingPageTransformer implements ViewPager.PageTransformer {
    ...
    public void transformPage(View page, float position) {
        ...
        if (position <= -1.0f || position >= 1.0f) {
            ...
            LottieAnimationView computer = page.findViewById(R.id.lav_thumbUp);
            switch (pagePosition) {

                case 1:

                    computer.setAnimation("image.json");
            ...
            //   animationView.setAnimation("dyslexia.json");

            computer.loop(true);

            //  animationView.addColorFilter(new PorterDuffColorFilter(Color.parseColor("#FFF"), PorterDuff.Mode.SRC_ATOP));

            computer.enableMergePathsForKitKatAndAbove(true);
            ...
            title.setTranslationX(pageWidthTimesPosition * 1.5f);
            ...
            description.setTranslationX(pageWidthTimesPosition * 3.0f);
            ...
            if (computer != null) {
                ...
                computer.setTranslationX(pageWidthTimesPosition * 0.8f);
